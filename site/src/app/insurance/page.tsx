    ...
    <>
      <section className="border-b border-[--color-border] hero-bg">
        <div className="mx-auto max-w-[1400px] px-6 py-24 sm:px-10 sm:py-32">
          ...
          <h1 className="h-display max-w-[22ch]" style={{ fontSize: "clamp(2.6rem, 7vw, 4.6rem)" }}>
            ...
            <span className="h-serif text-[--color-rose]">no surprises</span>.
          </h1>
        ...
        <div className="grid gap-10 md:grid-cols-2">
          <Reveal>
            <div className="card p-8 h-full">
              ...
              <h2 className="font-display text-2xl text-[--color-plum] mb-5 leading-tight">Most major plans accepted</h2>
              ...
              <ul className="space-y-2 text-sm text-[--color-ink]">
                <li className="flex items-baseline gap-3 border-b border-[--color-border] py-2">
              ...
              <p className="text-[13px] text-[--color-muted] mt-5 italic">
          ...
          <Reveal>
            <div className="card p-8 h-full">
              ...
              <h2 className="font-display text-2xl text-[--color-plum] mb-5 leading-tight">Transparent cash rates</h2>
              <p className="text-[--color-muted] leading-relaxed mb-4">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-baseline justify-between gap-3 border-b border-[--color-border] py-2">
                  <span className="text-[--color-ink]">Student sports physical (13–17)</span>
                  <span className="font-mono text-[--color-rose-deep]">$55</span>
                </li>
                <li className="flex items-baseline justify-between gap-3 border-b border-[--color-border] py-2">
                  <span className="text-[--color-ink]">DOT physical</span>
                  <span className="font-mono text-[--color-muted]">Call for rate</span>
                </li>
                <li className="flex items-baseline justify-between gap-3 border-b border-[--color-border] py-2">
                  <span className="text-[--color-ink]">Drug screen (panel-dependent)</span>
                  <span className="font-mono text-[--color-muted]">Call for rate</span>
                </li>
                <li className="flex items-baseline justify-between gap-3 border-b border-[--color-border] py-2">
                  <span className="text-[--color-ink]">Wellness Snap Shot</span>
                  <span className="font-mono text-[--color-muted]">Call for rate</span>
                </li>
              </ul>
              <p className="text-[13px] text-[--color-muted] mt-5 italic">
      ...
      <section className="border-t border-[--color-border] bg-white">
        <div className="mx-auto max-w-[900px] px-6 py-20 text-center sm:px-10">
          <Reveal>
            <p className="h-serif text-[--color-rose]" style={{ fontSize: "clamp(1.1rem, 1.8vw, 1.35rem)" }}>
            ...
            <a
              ...
              className="mt-8 inline-flex items-center gap-3 bg-[--color-rose] text-white px-7 py-4 font-semibold rounded-full hover:bg-[--color-rose-deep] transition-colors"
            >
              Call {CLINIC.phoneDisplay}
            </a>
            <div className="mt-4">
              <Link href="/contact" className="text-sm font-medium text-[--color-muted] hover:text-[--color-plum] underline underline-offset-4">
